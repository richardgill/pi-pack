...
const segmentCases: TestCase[] = [
  { name: "accepts plain segment", input: "files", expected: { ok: true } },
  {
    name: "accepts hyphenated segment",
    input: "pi-preset",
    expected: { ok: true },
  },
  {
    name: "accepts segment with space",
    input: "rich files",
    expected: { ok: true },
  },
  {
    name: "accepts segment with extension",
    input: "config.json",
    expected: { ok: true },
  },
  {
    ...
    expected: {
      ok: false,
      error: "Name must be a single filesystem path segment: ../files.",
    },
  },
  {
    ...
    expected: {
      ok: false,
      error: "Name must be a single filesystem path segment: .",
    },
  },
  {
  ...
  },
  {
    ...
    expected: {
      ok: false,
      error: "Name must be a single filesystem path segment: has:colon.",
    },
  },
  {
    ...
    expected: {
      ok: false,
      error: "Name must be a single filesystem path segment: has?question.",
    },
  },
  {
    ...
    expected: {
      ok: false,
      error: "Name must be a single filesystem path segment: trailing..",
    },
  },
  {
  ...
  },
  {
    ...
    expected: {
      ok: false,
      error: "Name must be a single filesystem path segment: CON.",
    },
  },
  {
    ...
    expected: {
      ok: false,
      error: "Name must be a single filesystem path segment: nul.txt.",
    },
  },
  {
    ...
    expected: {
      ok: false,
      error: "Name must be a single filesystem path segment: LPT³.log.",
    },
  },
];
