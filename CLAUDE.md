...
This is a CLI tool for installing and updating pi extensions.
...
E2E tests are organized 1:1 with commands - each command has its own e2e test file in the command's directory (e.g., `src/commands/install/impl.e2e.test.ts`).
